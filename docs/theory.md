# emotion_spirit v2.0 理论依据

> **目的**: 解释 emotion_spirit 每个机制背后的理论来源, 帮助 maintainer 理解设计意图, 避免无根据的"重构".
> **范围**: v2.0 收尾涉及的所有理论, 涵盖 Phase 0.5-3.0C + Phase 4 (C1-C5).
...
emotion_spirit 整体架构的隐喻来源。SylannEngine 处理 Id (即时情感, ms ~ hr), emotion_spirit v2.0 处理 Ego (长期记忆 + 人格演化, hr ~ month) + Superego (价值对齐 + 良心压力, 贯穿).
